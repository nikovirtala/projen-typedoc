...
| <code><a href="#@nikovirtala/projen-typedoc.TypeDoc.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@nikovirtala/projen-typedoc.TypeDoc.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@nikovirtala/projen-typedoc.TypeDoc.with.parameter.mixins"></a>
